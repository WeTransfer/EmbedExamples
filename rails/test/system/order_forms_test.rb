...
class OrderFormsTest < ApplicationSystemTestCase
  ...
  test "creating a Order form" do
    visit order_forms_url
    click_on "New Order Form"

    fill_in "Description", with: @order_form.description
    fill_in "Quantity", with: @order_form.quantity
  ...
  test "destroying a Order form" do
    visit order_forms_url
